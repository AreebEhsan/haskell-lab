...
/* package haskell-lab-0.1.0.0 */
#ifndef VERSION_haskell_lab
#define VERSION_haskell_lab "0.1.0.0"
#endif /* VERSION_haskell_lab */
#ifndef MIN_VERSION_haskell_lab
#define MIN_VERSION_haskell_lab(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_lab */
...
#define CURRENT_COMPONENT_ID "haskell-lab-0.1.0.0-inplace-haskell-lab"
